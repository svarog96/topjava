...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2016, Month.MAY, 29, 10, 0), "Завтрак", 1050, 3),
            new Meal(LocalDateTime.of(2016, Month.MAY, 29, 13, 0), "Обед", 300, 3),
            new Meal(LocalDateTime.of(2016, Month.MAY, 29, 20, 0), "Ужин", 589, 3)
    );
